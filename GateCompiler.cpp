...
//            temp.clear(); // Clear temp after pushing to postfix
//        }
//        else if (ch == '(') {
//            operators.push(ch);
//        }
...
//        }
//        else if (ch == '&' || ch == '|' || ch == '~') { // Handle operators
...
//
//
//bool evaluatePostfix(vector<string> postfix, vector<bool> ins) {
//    stack<bool> operands;
...
//    for (int i = 0; i < postfix.size(); i++) {
//        if (isalpha(postfix[i].at(0))) {
//            operands.push(map[postfix[i]]); // Push the boolean value, not the pair
//        }
...
//            }
//        }
//        else if (postfix[i] == "~") { // Handle negation
//            bool operand1 = operands.top();
//            operands.pop();
